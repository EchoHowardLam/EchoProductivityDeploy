...
let Configuration =
  ...
  ,   _startingApps = { _center = Some "./result/bin/xfce4-terminal"
                      , _right  = Some ""
                      , _bottom = Some ""
                      , _left   = Some "./result/bin/xfce4-terminal"
                      , _top    = Some ""
                      }
  ...
  , _keyBindings             = [ -- For keyboard shortcuts, use keynames from
                              ...
                              , { _keyCombination = ["KEY_MASK_META", "KEY_W"]                         , _keyAction = "./result/bin/ffplay -f v4l2 /dev/video0"            }
  ...
  , _environmentDefault    = "./environments/1567215018536-ESA_Gaia_DR2_AllSky_Brightness_Colour_Cartesian_4000x2000.png"
  , _scenes = [] : List Text
